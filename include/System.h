...
public:
    ...
    // Save dense point cloud (PLY) generated by DenseMapping.
    bool SaveDensePointCloud(const string &filename, bool use_latest_pose = true);
