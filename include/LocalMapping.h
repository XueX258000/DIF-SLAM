...
public:
    ...
    void EnqueueDIFPruneTrackIds(const std::vector<int>& ids);
...
protected:
    ...
    std::mutex mMutexDIFPrune;
    std::unordered_set<int> mDIFPendingPruneTrackIds;
